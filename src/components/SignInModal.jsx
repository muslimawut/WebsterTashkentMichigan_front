        ...
        <div className="text-center">
          ...
          <div className="text-left bg-blue-50 rounded-lg p-6 mb-6">
            <p className="text-gray-700 mb-4 leading-relaxed">
              To take the Michigan Test, you need to:
            </p>
            <ol className="space-y-3 text-gray-700">
              ...
              <li className="flex items-start">
                ...
                <span>Once selected, you'll receive access credentials to take the test</span>
              </li>
            </ol>
          </div>
          ...
          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6 text-left">
            <div className="flex items-start">
              ...
              <p className="text-sm text-yellow-800 font-medium">
                Important: You can only sign in after your application is approved
              </p>
            </div>
          </div>
