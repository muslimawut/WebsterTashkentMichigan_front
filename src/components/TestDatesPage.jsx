...
const TestDatesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 page-enter">
      {/* Header */}
      <div className="bg-gray-900/50 border-b border-gray-800 backdrop-blur-sm sticky top-0 z-[100]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-xl font-bold text-white">Test Dates</h1>
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          <div className="text-center mb-16">
            <h2
              className={`text-3xl sm:text-5xl lg:text-5xl font-bold text-white mb-6 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                }`}
              style={{ transitionDelay: '0.2s' }}
            >
              All Available Test Dates
            </h2>
            <p
                  ...
                  >
                    <div className="flex flex-col items-center p-6 gap-4 h-full text-center flex-1">
                      ...
                      <div className="flex flex-col items-center gap-2 flex-1">
                        ...
                        {date.isFull ? (
                          <span className="inline-flex items-center gap-1.5 text-red-400 text-xs font-semibold bg-red-500/10 px-2.5 py-1 rounded-lg border border-red-500/20 w-fit">
                            <span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse"></span>
                            Full
                          </span>
                        ) : (
                          <span className="inline-flex items-center gap-1.5 text-green-400 text-xs font-semibold bg-green-500/10 px-2.5 py-1 rounded-lg border border-green-500/20 w-fit">
